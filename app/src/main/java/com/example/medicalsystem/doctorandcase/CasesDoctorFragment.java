...
import com.example.medicalsystem.databinding.FragmentCasesDoctorBinding;
 ...
 * Use the {@link CasesDoctorFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CasesDoctorFragment extends Fragment {
     ...
     * @return A new instance of fragment CasesDoctorFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static CasesDoctorFragment newInstance(String param1, String param2) {
        CasesDoctorFragment fragment = new CasesDoctorFragment();
    ...
    private FragmentCasesDoctorBinding binding;
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCasesDoctorBinding.inflate(inflater, container, false);
    ...
    private void onClickOnBackIcon() {
        binding.backCasessdoctor.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void observeCaseDetailsResponse(int caseId) {
        ...
        medicalSystemViewModel.getMutableLiveDataShowCase().observe(getViewLifecycleOwner(), new Observer<ShowCaseResponseData>() {
            ...
            public void onChanged(ShowCaseResponseData showCaseResponseData) {
                ...
                Navigation.findNavController(view).navigate(R.id.action_casesDoctorFragment_to_caseDetailsDoctorFragment,bundle); //Send Case Details To caseDetailsDoctorFragment
            }
        });
    }
        ...
        medicalSystemViewModel.getSingleLiveEventAllCases().observe(getViewLifecycleOwner(),new EventObserver<CasesResponseModel>(new EventHandler<CasesResponseModel>() {
            ...
            public void onEventUnHandled(CasesResponseModel object) {
                if(object.getStatus() == 1){
                    ...
                    binding.recycleCasessdoctor.setAdapter(myRecycleAdapterCases);//Set Adapter to Recycler
                }else {
