...
import com.example.medicalsystem.databinding.FragmentManagerBinding;
...
public class ManagerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        onClickOnEmployeeIcon();      //Set On CLick On Employee Icon
    ...
    private void onClickOnReportsIcon() {
        binding.reportsManager.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_managerFragment_to_reportFragment);
            }
        });
    }
    ...
    private void onClickonAttendance() {
        binding.attendanceManager.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_managerFragment_to_attendanceandLeavingFragment);
            }
        });
    }
    private void onClickOnLogout() {
        binding.logoutManager.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void onClickOnCardImageProfile() {
        binding.cardimageManager.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_managerFragment_to_myProfileFragment);
            }
        });
    }

    private void setProfileImage() {
        Glide.with(this).load(PROFILE_IMAGE).into(binding.imageManager); //Load Image From Link
    }


    private void onClickOnEmployeeIcon() {
        binding.employeeManager.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_managerFragment_to_employeeListFragment);
            }
        });
    }

    private void onCLickOnTasksIcon() {
        binding.tasksManager.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_managerFragment_to_tasksmanagerFragment);
            }
        });
    }

    private void onClickOnCasesIcon() {
        binding.casesManager.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_managerFragment_to_casesManagerFragment);
            }
        });
    }
